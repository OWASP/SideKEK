...
/**
 * Secret folder-based keystore unit tests.
 * 
 * @author Dmitriy Beryoza
 * @author Ron Craig
 */
public class SecretFolderKeyStoreTest {
	...
	public void testFullCycle() throws Exception {
		...
		LoadStoreParameter param = new SecretFolderKeyStoreSpi.SecretFolderKeyStoreParameter(folder); 
